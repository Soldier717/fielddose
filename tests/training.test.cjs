...
for(const name of ['training-data.js','question-bank.js'])vm.runInContext(fs.readFileSync(path.join(dir,name),'utf8'),ctx);
...
console.log('OK — training source integrity, 200 questions, 36 medications, 14 drills, 3 scenarios, assets and routes.');
